...
| 세션 | 주제 | 상태 |
|------|------|------|
| 07 | 동적 메모리 (Dynamic Memory) | ⬜ 대기 |
| 08 | 파일 I/O (File I/O) | ⬜ 대기 |
...
| 14 | 스택 & 큐 (Stack & Queue) | ⬜ 대기 |
| 15 | 재귀 (Recursion) | ⬜ 대기 |
| 16 | 함수 포인터 & 콜백 (Function Pointers) | ⬜ 대기 |
| 17 | 멀티파일 프로젝트 (Multi-file Project) | ⬜ 대기 |
| 18 | 커맨드라인 인자 (Command-line Args) | ⬜ 대기 |
| 19 | 해시 테이블 (Hash Table) | ⬜ 대기 |
...
|------|------|------|
| 01 | C++ 기초 & iostream | ⬜ 대기 |
| 02 | 문자열 & 네임스페이스 (String & Namespace) | ⬜ 대기 |
| 03 | 제어 흐름 (Control Flow) | ⬜ 대기 |
| 04 | 함수 & 오버로딩 (Functions & Overloading) | ⬜ 대기 |
...
- **일일 분량**: 2세션
- **예상 소요**: 약 17일 (Day 1~7: C 남은 세션, Day 8~17: C++)
- **자동화**: Hermes Agent cron job (`pro-c-daily-learning`)
- **완료 조건**: 40세션 전부 완료 시 프로젝트 종료
